...
function outside( temp, humid, cloudy ){
	if (temp > 80 && humid > 40){
		return "I'm all sweat"
	}
	else if (temp < 40 && cloudy > 60) {
		return "I have icecicles"
	}
	else if (temp > 80 && humid < 40 && cloudy < 20) {
		return "I'm literally in the desert"
	}
	else if (temp > 80 || humid > 50 || cloudy > 50) {
